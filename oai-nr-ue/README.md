...
1. If you are using nr-ue with multus interface then configure the gNB/DU ip-address or FQDN in `config.rfSimServer` (not recommended, as splitting NR-UE from RF simulator might create issues).
